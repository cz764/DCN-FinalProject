...
//------------------------------------
  ...
  class setupButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent e) {
	  ...
	  try{
	    ...
	    System.out.println("Video client: Recovering video at port " + RTP_RCV_PORT);
  ...
  private void send_RTSP_request(String request_type) {
    ...
    try{
    	System.out.println("Sending RTSP request of type " + request_type);
      ...
      if (request_type.startsWith("SETUP")) {
    	  RTSPBufferedWriter.write("Transport: RTP/AVP unicast; client_port= " + RTP_RCV_PORT +  CRLF); 
      }
